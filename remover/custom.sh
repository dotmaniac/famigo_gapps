...
sed 's/#.*//' /sdcard/Famigo/junk.txt > /sdcard/Famigo/tmp.txt
...
mv /sdcard/Famigo/tmp.txt /sdcard/Famigo/custom-tmp.log.txt
cp /tmp/aroma/remover-custom.prop /sdcard/NU/Logs/remover-custom.prop